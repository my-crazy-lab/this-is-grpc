...
var file_proto_auth_auth_proto_rawDesc = string([]byte{
	...
	0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x32, 0x97, 0x05, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12,
	...
	0x79, 0x2d, 0x63, 0x72, 0x61, 0x7a, 0x79, 0x2d, 0x6c, 0x61, 0x62, 0x2f, 0x74, 0x68, 0x69, 0x73,
	0x2d, 0x69, 0x73, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2d, 0x6d,
	0x6f, 0x64, 0x75, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x61, 0x75, 0x74, 0x68,
...
var file_proto_auth_auth_proto_goTypes = []any{
	...
	(*product.GetCategoriesRequest)(nil),     // 9: product.GetCategoriesRequest
	(*product.GetProductsRequest)(nil),       // 10: product.GetProductsRequest
	(*product.CreateReviewRequest)(nil),      // 11: product.CreateReviewRequest
	(*product.GetReviewsRequest)(nil),        // 12: product.GetReviewsRequest
	(*product.CreateProductResponse)(nil),    // 13: product.CreateProductResponse
	(*product.CreateCategoriesResponse)(nil), // 14: product.CreateCategoriesResponse
	(*product.GetCategoriesResponse)(nil),    // 15: product.GetCategoriesResponse
	(*product.GetProductsResponse)(nil),      // 16: product.GetProductsResponse
	(*product.CreateReviewResponse)(nil),     // 17: product.CreateReviewResponse
	(*product.GetReviewsResponse)(nil),       // 18: product.GetReviewsResponse
}
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	9,  // 6: auth.Auth.GetCategories:input_type -> product.GetCategoriesRequest
	10, // 7: auth.Auth.GetProducts:input_type -> product.GetProductsRequest
	11, // 8: auth.Auth.CreateReview:input_type -> product.CreateReviewRequest
	12, // 9: auth.Auth.GetReviews:input_type -> product.GetReviewsRequest
	2,  // 10: auth.Auth.Login:output_type -> auth.LoginResponse
	3,  // 11: auth.Auth.Register:output_type -> auth.RegisterResponse
	5,  // 12: auth.Auth.GetUsers:output_type -> auth.GetUsersResponse
	13, // 13: auth.Auth.CreateProduct:output_type -> product.CreateProductResponse
	14, // 14: auth.Auth.CreateCategories:output_type -> product.CreateCategoriesResponse
	15, // 15: auth.Auth.GetCategories:output_type -> product.GetCategoriesResponse
	16, // 16: auth.Auth.GetProducts:output_type -> product.GetProductsResponse
	17, // 17: auth.Auth.CreateReview:output_type -> product.CreateReviewResponse
	18, // 18: auth.Auth.GetReviews:output_type -> product.GetReviewsResponse
